  ...
  return (
    <header className="flex flex-col gap-4 md:flex-row md:items-center md:justify-between">
      ...
      <div className="flex flex-wrap items-center justify-start gap-2 md:justify-end">
        ...
        <LabelLanguageToggle />
        <a
          href="https://github.com/JupiterPi/ohrni"
          target="_blank"
          rel="noopener noreferrer"
          aria-label="View source on GitHub"
          className="inline-flex h-7 w-7 items-center justify-center rounded-full border border-slate-700/80 bg-slate-950/80 text-slate-400 shadow-inner transition-colors hover:border-slate-500 hover:text-slate-200"
        >
